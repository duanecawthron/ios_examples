= touchesBegan shows how handle an event or pass it to the next responder
...
Gestures are recognized in multiple level of the view hierarchy regardless of whether or not the touches are passed to super.
