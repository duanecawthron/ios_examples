...
030_touchesBegan:: touchesBegan shows how handle an event or pass it to the next responder
...
033_addChildViewController:: addChildViewController adds a child view controller to the responder chain used to handle events
