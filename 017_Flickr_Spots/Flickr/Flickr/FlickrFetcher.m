...
/*
Valid place_type_id values are :
    22: neighbourhood
    7: locality
    8: region
    12: country
...
+ (NSArray *)topPlaces
{
    ...
    request = [NSString stringWithFormat:@"http://api.flickr.com/services/rest/?method=flickr.places.getTopPlacesList&place_type_id=22"];
